    ...
    return (
        <div>
            ...
            <main className="container d-flex align-items-center justify-content-center min-vh-100">
                <div className="w-50 text-gray-600 space-y-3 p-4 shadow border rounded">
                    ...
                    <p className="text-center">
                        Don't have an account? <Link to="/ERP_Project/signup" className="font-bold">Sign up</Link>
                    </p>
                    <hr className="my-4" />
                    <button
                        disabled={isSigningIn}
                        onClick={onGoogleSignIn}
                        className={`w-full btn btn-light d-flex align-items-center justify-content-center gap-x-3 ${
