...
const SideMenu: React.FC = () => {
  ...
  const handleRowClick = (rowId: string) => {
    ...
    if (rowId === "row-11") {
      ...
      else if(rowId === "row-12"){
        history.push("/sidemenu")
      }
      else if(rowId === "row-13"){
        history.push("/sidemenu")
      }
      else if(rowId === "row-14"){
        history.push("/sidemenu")
      }
      else if(rowId === "row-15"){
        history.push("/sidemenu")
      }
  };
  ...
  return (
    <IonRow className="row-20">
      <IonCol className="col-1">
        ...
        <IonRow className={`row-11 ${isRowActive("row-11") ? "active-row" : ""}`} onClick={() => handleRowClick("row-11")}>
          <svg
            ...
            viewBox="0 0 16 16"
            color={getIconColor("row-11")}
          >
            <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4z" />
          </svg>
          <div className="title" style={{ color: getTitleColor("row-11") }}>Dashboard</div>
        </IonRow>
        <IonRow className={`row-12 ${isRowActive("row-12") ? "active-row" : ""}`} onClick={() => handleRowClick("row-12")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            ...
            viewBox="0 0 16 16"
            color={getIconColor("row-12")}
          >
            <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664z" />
          </svg>
          <div className="title" style={{ color: getTitleColor("row-12") }}>Students</div>
        </IonRow>
        <IonRow className={`row-13 ${isRowActive("row-13") ? "active-row" : ""}`} onClick={() => handleRowClick("row-13")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            ...
            className="bi bi-person"
            viewBox="0 0 16 16"
            color={getIconColor("row-13")}
          >
            <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664z" />
          </svg>
          <div className="title" style={{ color: getTitleColor("row-13") }}>Parents</div>
        </IonRow>
        <IonRow className={`row-14 ${isRowActive("row-14") ? "active-row" : ""}`} onClick={() => handleRowClick("row-14")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          ...
          <div className="title" style={{ color: getTitleColor("row-14") }}>Finance</div>
        </IonRow>
        <IonRow className={`row-15 ${isRowActive("row-15") ? "active-row" : ""}`} onClick={() => handleRowClick("row-15")}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
          ...
          <div className="title" style={{ color: getTitleColor("row-15") }}>User</div>
        </IonRow>
      </IonCol>
    </IonRow>
  );
