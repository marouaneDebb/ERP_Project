          ...
          <IonRow className="rounded">
            <IonRow className="Elements col-3">
                ...
                <defs>
                  <clipPath id="clip0_479_1268">
                    <rect
                      ...
                      height="27.7778"
                      fill="white"
                      transform="translate(11.1113 11.1111)"
                    />
                  </clipPath>
                </defs>
              </svg>
              ...
              <IonCol>
                ...
                <p className="subTitle">
                  <span style={{ color: getColor(percentStudent) }}>
                    {percentStudent}%
                  </span>{" "}
                  than last month
                </p>
            ...
            <IonRow className="Elements col-3">
                ...
                <defs>
                  <clipPath id="clip0_479_1277">
                    <rect
                      ...
                      height="27.7778"
                      fill="white"
                      transform="translate(11.5947 11.1111)"
                    />
                  </clipPath>
                </defs>
              </svg>
              ...
              <IonCol>
                ...
                <h4>345</h4>
                <p className="subTitle">
                  <span style={{ color: getColor(percentParent) }}>
                    {percentParent}%
                  </span>{" "}
                  than last month
                </p>
            ...
            <IonRow className="Elements col-5">
                ...
                <defs>
                  <clipPath id="clip0_457_1941">
                    <rect
                      ...
                      height="27.7778"
                      fill="white"
                      transform="translate(11.1111 11.1111)"
                    />
                  </clipPath>
                </defs>
              </svg>
              ...
              <IonCol>
                ...
                <h4>$1245.650</h4>
                <p className="subTitle">
                  <span style={{ color: getColor(percentExpense) }}>
                    {percentExpense}%
                  </span>{" "}
                  than last month
                </p>
              ...
              >
                <path
                  d="M30.2852 25.7289C17.6011 26.875 12.5348 45.2014 2 45.2014V68H17.9882H171.983L172 21.3644C161.342 24.7809 154.585 -0.190208 143.715 2.15584C131.764 4.73524 129.74 33.7865 115.43 33.7865C104.157 33.7865 98.2906 22.7554 87.1443 24.7217C74.0672 27.0286 71.7426 56.8038 58.5705 58.1989C46.963 59.4282 41.9057 24.6789 30.2852 25.7289Z"
                  fill="url(#paint0_linear_457_1933)"
                  fill-opacity="0.25"
                />
                <path
                  d="M2 44.906C12.5348 44.906 17.6011 26.7049 30.2852 25.5666C41.9057 24.5238 46.963 59.0354 58.5705 57.8145C71.7426 56.429 74.0672 26.8575 87.1443 24.5663C98.2906 22.6135 104.157 33.5691 115.43 33.5691C129.74 33.5691 131.764 4.71654 143.715 2.15477C154.585 -0.175229 161.342 24.6251 172 21.2319"
                  stroke="#4C50BC"
                  stroke-width="4"
